...
cd = Item("CD Player",
          "Your attention is drawn to Return of the King. When did it come out again?", "C", [1, 7])
tv = Item("TV Remote",
          "You pick up the TV remote. The TV flickers on and asks\n 'When was paradise lost?'", "T", [4, 7])
book = Item(
    "Book", "Your attention is drawn to Paradise Lost. You pick up the book.", "B", [1, 8])
...
lvl = Game(map, player_pos, items, inventory,
           None, door_locations, "level1.pkl")
